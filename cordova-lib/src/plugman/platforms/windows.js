...
module.exports = {
    ...
    package_name:function(project_dir) {
        // Windows8.1: for smooth transition and to prevent plugin handling
        // failures we try to parse old package.appxmanifest also.
        ...
        manifest = xml_helpers.parseElementtreeSync(manifestPath);
    ...
    "framework": {
        install:function(el, plugin_dir, project_dir, plugin_id, project_file) {
            ...
            if(type == "projectReference") {
                ...
                project_file.addReference('$(MSBuildThisFileDirectory)'+dest,src);
            }
        ...
        uninstall:function(el, project_dir, plugin_id, project_file) {
            ...
            if(type == "projectReference") {
                ...
                project_file.removeReference('$(MSBuildThisFileDirectory)'+ src);
            }
        }
    }
};
